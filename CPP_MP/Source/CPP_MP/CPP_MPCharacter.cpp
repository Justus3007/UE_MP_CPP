...
void ACPP_MPCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ACPP_MPCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ACPP_MPCharacter::Look);
	}
	else
	{
...
void ACPP_MPCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ACPP_MPCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
